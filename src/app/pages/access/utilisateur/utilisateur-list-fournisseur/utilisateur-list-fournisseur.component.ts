...
import { ListModel } from '../utilisateur-list/list.model';
import { Observable } from 'rxjs';

import { NgbdListSortableHeader, listSortEvent } from '../utilisateur-list/list-sortable.directive';
...
import { ListServiceSupplier } from '../utilisateur-list/list.serviceSupplier';



@Component({
  selector: 'app-utilisateur-list-fournisseur',
  templateUrl: '../utilisateur-list/utilisateur-list.component.html',
  styleUrls: ['./utilisateur-list-fournisseur.component.css'],
  providers: [ ListServiceSupplier,  DecimalPipe]
})
export class UtilisateurListFournisseurComponent implements OnInit {
  ...
  constructor(
                public service: ListServiceSupplier,
  ...
  addBuyer(e: Event){
    ...
    e.preventDefault()
      this.router.navigate(['../access/utilisateur/nouveau' , this.categorie]);
