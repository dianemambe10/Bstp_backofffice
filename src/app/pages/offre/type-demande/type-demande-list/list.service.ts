...
export class ListService {
  ...
  user = [];
  typeDemandes: any | undefined;
  Products$: any;
  typeDemandes$: any;
  constructor(private pipe: DecimalPipe, private typeDemandeService: TypeDemandeService) {
    this._search$.pipe(
    ...
    this.retrieveTypeDemande()
  }

  retrieveTypeDemande(): void {
    this.typeDemandeService.getData()
      .subscribe({
        next: (data) => {
  ...
  get typeDemande() { return this.typeDemandes; }
