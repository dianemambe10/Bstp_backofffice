...
export class ListComponent implements OnInit {
  ...
  constructor(
                ...
                public formationService: FormationServices,
  ...
  addBuyer(e: Event){
    ...
    e.preventDefault()
      this.router.navigate(['../learning/formation/nouveau']);
  ...
  editItem(e: Event, id: any){
    e.preventDefault()
      this.router.navigate(['../learning/formation/edit', id]);
  }
  detailItem(e: Event, id: any){
    e.preventDefault()
      this.router.navigate(['../learning/formation/details', id]);
  }
 ...
 confirmDelete() {
   if (this.deleteID) {
     this.formationService.delete(this.deleteID).subscribe({
       next: (res)=> {

         this.toastService.success('La suppression d\' une formation a été effectué avec success', 'Succèss',{
           timeOut: 3000,
         })
