...
export class ListComponent implements OnInit {
  ...
  constructor(
                ...
                public financementService: FinancementServices,
  ...
  addBuyer(e: Event){
    ...
    e.preventDefault()
      this.router.navigate(['../learning/financement/nouveau']);
  ...
  editItem(e: Event, id: any){
    e.preventDefault()
      this.router.navigate(['../learning/financement/edit', id]);
  }
  detailItem(e: Event, id: any){
    e.preventDefault()
      this.router.navigate(['../learning/financement/details', id]);
  }
 ...
 confirmDelete() {
   if (this.deleteID) {
     this.financementService.delete(this.deleteID).subscribe({
       next: (res)=> {

         this.toastService.success('La suppression d\' un financement a été effectué avec success', 'Succèss',{
           timeOut: 3000,
         })
