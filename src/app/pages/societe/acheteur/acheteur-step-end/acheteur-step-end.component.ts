...
@Component({
  selector: 'app-acheteur-step-end',
  templateUrl: './acheteur-step-end.component.html',
  styleUrls: ['./acheteur-step-end.component.scss']
})
export class AcheteurStepEndComponent {
  @Input()
  demandeur!: User;
