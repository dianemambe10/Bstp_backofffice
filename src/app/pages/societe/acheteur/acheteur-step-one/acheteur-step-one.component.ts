...
@Component({
  ...
  templateUrl: './acheteur-step-one.component.html',
  styleUrls: ['./acheteur-step-one.component.scss']
})
export class AcheteurStepOneComponent implements AfterViewInit, OnInit {
