...
@Component({
  selector: 'app-personne-contact-list',
  templateUrl: './personne-contact-list.component.html',
  styleUrls: ['./personne-contact-list.component.scss'],
  providers: [ListService, DecimalPipe]
})
export class PersonneContactListComponent {
 // bread crumb items
